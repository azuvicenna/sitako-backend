...
jest.mock("@/controllers/librarian/librarian.controller", () => ({
  ...
  createLibrarian: jest.fn((req, res) =>
    res.status(201).json({ success: true, data: mockLibrarian, message: "Pustakawan berhasil ditambahkan" })
  ),
  updateLibrarian: jest.fn((req, res) =>
    res.status(200).json({ success: true, data: mockLibrarian, message: "Pustakawan berhasil diperbarui" })
  ),
...
jest.mock("@/controllers/librarian/member.controller", () => ({
  ...
  showMember: jest.fn((req, res) =>
    res.status(200).json({ success: true, data: mockMember })
  ),
  createMember: jest.fn((req, res) =>
    res.status(201).json({ success: true, data: mockMember, message: "Anggota berhasil ditambahkan" })
  ),
  updateMember: jest.fn((req, res) =>
    res.status(200).json({ success: true, data: mockMember, message: "Anggota berhasil diperbarui" })
  ),
