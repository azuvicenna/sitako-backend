...
import * as shelfService from "@/services/librarian/shelf/shelf.service";
import { getPaginationParams, sendError, sendSuccess } from "@/utils/core/handler";
import { createShelfSchema, updateShelfSchema } from "@/validations/shelf.schema";
...
export const updateShelf = async (req: Request, res: Response) => {
  try {
    ...
    const result = await shelfService.updateExistingShelf(shelfId, validatedBody);
